...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference("Phone.count") do
      post phones_url, params: { phone: { phone_num: @phone.phone_num, profile_id: @phone.profile_id } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { phone_num: @phone.phone_num, profile_id: @phone.profile_id } }
