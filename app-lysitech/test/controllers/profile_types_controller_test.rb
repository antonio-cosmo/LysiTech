...
class ProfileTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profile_type" do
    assert_difference("ProfileType.count") do
      post profile_types_url, params: { profile_type: { description: @profile_type.description } }
    end
  ...
  test "should update profile_type" do
    patch profile_type_url(@profile_type), params: { profile_type: { description: @profile_type.description } }
